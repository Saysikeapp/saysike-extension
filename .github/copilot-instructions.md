...
| Alias              | Resolves to                |
| ------------------ | -------------------------- |
| `@saysike/ui`      | `src/lib/ui/src`           |
| `@saysike/utils`   | `src/lib/utils/src`        |
| `@saysike/http`    | `src/lib/http/src`         |
| `@saysike/schemas` | `src/lib/schemas/src`      |
...
- Messages between popup and background use `browser.runtime.sendMessage`. The type is `BrowserMessageRequest` from `@/lib/browserAPI`.
